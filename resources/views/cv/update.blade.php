...
<div class="container container--create_cv">
        <form action="{{route('put.update.cv')}}" method="post" class="form">
            ...
            <div class="form__container form__container--full form__container--top">
                ...
                <div class="error_msg">Cannot update CV because of validaiton errors.</div>
                @else
                <div class="success_msg">Click <a href="{{route('viewCV', auth()->user()->cv->id)}}" class="bold">here</a> to view it.</div>
                @endif
